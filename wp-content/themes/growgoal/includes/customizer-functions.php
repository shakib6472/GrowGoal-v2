...
function hello_customizer_register_elementor_pro_upsell( $wp_customize ) {
	...
	$wp_customize->add_section(
		new HelloElementor\Includes\Customizer\Hello_Customizer_Upsell(
			...
			[
				'heading' => esc_html__( 'Customize your entire website with Elementor Pro', 'growgoal' ),
				'description' => esc_html__( 'Build and customize every part of your website, including Theme Parts with Elementor Pro.', 'growgoal' ),
				'button_text' => esc_html__( 'Upgrade Now', 'growgoal' ),
