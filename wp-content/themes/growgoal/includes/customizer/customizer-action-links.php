		...
		switch ( $action_link_type ) {
			case 'install-elementor':
				$action_link_data = [
					...
					'alt' => esc_attr__( 'Elementor', 'growgoal' ),
					'title' => esc_html__( 'Install Elementor', 'growgoal' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'growgoal' ),
					'button' => esc_html__( 'Install Elementor', 'growgoal' ),
					'link' => wp_nonce_url(
						add_query_arg(
							[
			...
			case 'activate-elementor':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'growgoal' ),
					'title' => esc_html__( 'Activate Elementor', 'growgoal' ),
					'message' => esc_html__( 'Create cross-site header & footer using Elementor.', 'growgoal' ),
					'button' => esc_html__( 'Activate Elementor', 'growgoal' ),
			...
			case 'activate-header-footer-experiment':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'growgoal' ),
					'title' => esc_html__( 'Style using Elementor', 'growgoal' ),
					'message' => esc_html__( 'Design your cross-site header & footer from Elementor’s "Site Settings" panel.', 'growgoal' ),
					'button' => esc_html__( 'Activate header & footer experiment', 'growgoal' ),
			...
			case 'style-header-footer':
				$action_link_data = [
					'image' => get_template_directory_uri() . '/assets/images/elementor.svg',
					'alt' => esc_attr__( 'Elementor', 'growgoal' ),
					'title' => esc_html__( 'Style cross-site header & footer', 'growgoal' ),
					'message' => esc_html__( 'Customize your cross-site header & footer from Elementor’s "Site Settings" panel.', 'growgoal' ),
					'button' => esc_html__( 'Start Designing', 'growgoal' ),
