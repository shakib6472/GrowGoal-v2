<?php
    ...
    if(!empty( $ld_intro_video) && $ld_intor_video_image) : ?>
        ...
        <div class="intro-video-sidebar tpc_mb_0">
            <div class="intro-video" style="background-image:url(<?php if( has_post_thumbnail() ) : echo esc_url(get_the_post_thumbnail_url(get_the_ID(), $ld_course_image_size)); elseif($ld_custom_placeholder_image) :  echo esc_url($ld_custom_placeholder_image); else: echo esc_url($placholder_img); endif; ?>)"> <a href="<?php echo esc_url( $ld_intro_video ); ?>" class="edubin-popup-videos bla-2"><span class="flaticon-play"></span></a>
            </div>
        </div><!--   // End Intro video -->
