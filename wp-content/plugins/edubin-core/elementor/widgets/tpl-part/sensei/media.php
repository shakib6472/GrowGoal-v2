<?php
    ...
    <div class="intro-video-sidebar tpc_mb_0">
        <div class="intro-video" style="background-image:url(<?php if( has_post_thumbnail() ) : echo esc_url(get_the_post_thumbnail_url(get_the_ID(), $lp_course_image_size)); elseif($lp_custom_placeholder_image) :  echo esc_url($lp_custom_placeholder_image); else: echo esc_url($placholder_img); endif; ?>)"> <a href="<?php echo esc_url( $lp_intro_video ); ?>" class="edubin-popup-videos bla-2"><span class="flaticon-play"></span></a>
        </div>
    </div><!--   // End Intro video -->
