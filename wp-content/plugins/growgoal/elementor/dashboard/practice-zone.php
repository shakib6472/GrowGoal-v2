 <main class="twg-flex-1 twg-flex twg-flex-col  lg:twg-max-h-[calc(100vh-90px)] max-lg:twg-max-h-[calc(100vh-69px)] ">
     ...
     <section class="twg-flex-1 twg-pt-5 twg-flex twg-h-full max-lg:twg-flex-col max-lg:twg-overflow-y-auto max-lg:twg-px-4 max-lg:twg-space-y-6 max-lg:twg-pb-5 twg-relative twg-main-content-section"> <?php echo student_menu($settings['dashboard_page']); ?> <div class="twg-main-wrapper-content lg:twg-flex-1 lg:twg-overflow-y-auto lg:twg-px-5 max-lg:!twg-mt-0">
             ...
             <div class="twg-grid mm-md-2xl:twg-grid-cols-3 2xl:twg-grid-cols-4 lg:twg-gap-5 max-lg:twg-gap-4 twg-rounded-10px lg:twg-p-20px max-lg:twg-p-14px lg:twg-mb-3 twg-border twg-border-dark-100/70">
                 ...
                 <a href=" <?php echo home_url('dashboard/practice-details');  ?>" class="twg-h-full">
                     <div class="twg-border twg-h-full twg-border-dark-100/30 twg-rounded-10px twg-custom-shadow twg-p-16px twg-bg-secondary-400 twg-flex twg-flex-col twg-justify-center twg-min-h-168px">
                         ...
                         <p class="lg:twg-text-14px max-lg:twg-text-13px twg-text-dark-100 twg-mt-2 twg-mb-2"> Complete the Practice for Lesson 2. </p> <button class="twg-mt-5 twg-px-14px twg-py-10px twg-leading-none twg-rounded-lg twg-text-14px twg-font-medium twg-uppercase twg-transition-opacity twg-duration-300 twg-ease-linear hover:twg-opacity-80 twg-h-37px twg-w-full  twg-bg-primary-100 twg-text-white "> Enter Practice </button>
                     </div>
                 </a>
                 <a href="<?php echo home_url('dashboard/practice-details');  ?>" class="twg-h-full">
                     <div class="twg-border twg-h-full twg-border-dark-100/30 twg-rounded-10px twg-custom-shadow twg-p-16px  twg-flex twg-flex-col twg-justify-center twg-min-h-168px">
                         ...
                         <p class="lg:twg-text-14px max-lg:twg-text-13px twg-text-dark-100 twg-mt-2 twg-mb-2"> Complete the Practice for Lesson 3. </p> <button class="twg-mt-auto twg-ml-auto twg-flex twg-gap-3 twg-text-dark-100"> <span class="twg-text-14px twg-font-medium">Locked</span> <svg width="18" height="22" viewBox="0 0 18 22" fill="none" xmlns="http://www.w3.org/2000/svg">
