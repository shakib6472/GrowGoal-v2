    ...
    <div
      ...
      <div
        ...
        <div
          ...
          <a href=" <?php echo home_url('dashboard/schedule'); ?>" class="twg-main-btn sm:twg-w-114px">
            Schedule
          </a>
        </div>
      </div>
      <div class="twg-grid mm-md-2xl:twg-grid-cols-2 2xl:twg-grid-cols-3 twg-gap-5 twg-mt-10px twg-pb-6px">

        <a href="<?php echo home_url('dashboard/session'); ?>" class="twg-h-full">
          <div
