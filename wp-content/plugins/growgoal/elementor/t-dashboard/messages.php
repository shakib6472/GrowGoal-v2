         ...
         <div class="twg-main-wrapper-content lg:twg-flex-1 twg-flex twg-flex-col lg:twg-px-5 max-lg:!twg-mt-0">
             ...
             <div class="twg-mt-5 twg-flex twg-items-stretch lg:twg-flex-1 lg:twg-h-[calc(100svh-160px)] max-lg:twg-h-[calc(100svh-140px)] max-lg:twg-flex-wrap">
                 ...
                 <div class="twg-flex-1 twg-flex twg-h-full max-lg:twg-flex-col max-lg:twg-overflow-y-auto twg-message-wrapper max-md:twg-hidden">
                     <div class="md:twg-hidden"> <button class="twg-message-close-btn twg-size-8 twg-min-h-8 twg-mb-5 twg-rounded-full twg-border twg-border-dark-100 twg-transition-colors twg-duration-300 twg-ease-linear hover:twg-bg-dark-100 hover:twg-text-accent-100 twg-grid twg-place-items-center"> <i class="fa-solid fa-arrow-left"></i> </button> </div>
                     <div class="twg-flex-1 lg:twg-h-full lg:twg-overflow-y-auto">
                         ...
                         <div class="twg-relative twg-mt-5">
                                 ...
                                 <div class="lg:twg-max-w-80/100">
                                     <div class="twg-flex twg-gap-3">
                                         ...
                                         <div class="twg-flex-1 twg-space-y-2">
                                             ...
                                             <div class="twg-flex twg-items-center">
                                                 ...
                                                 <div class="twg-relative"> <button class="dropdown-action twg-pl-3"> <svg width="4" height="14" viewBox="0 0 4 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                     ...
                                                     <div class="twg-absolute twg-top-full twg-right-0 twg-min-w-90px twg-w-full twg-bg-white twg-shadow-md twg-rounded-md twg-hidden dropdown-menu twg-z-50">
                                                         <ul class="twg-list-none twg-px-2 twg-py-1 twg-space-y-1">
                                                             <li class="twg-text-12px twg-text-dark-100 twg-py-2px twg-cursor-pointer twg-flex twg-items-center twg-gap-2 twg-transition-opacity twg-duration-300 twg-ease-linear hover:twg-opacity-70"> <i class="fa-solid fa-user"></i> <span>Profile</span> </li>
                                                             <li class="twg-text-12px twg-text-dark-100 twg-py-2px twg-cursor-pointer twg-flex twg-items-center twg-gap-2 twg-transition-opacity twg-duration-300 twg-ease-linear hover:twg-opacity-70"> <i class="fa-solid fa-gear"></i> <span>Settings</span> </li>
                                                             <li class="twg-text-12px twg-py-2px twg-cursor-pointer twg-flex twg-items-center twg-gap-2 twg-transition-opacity twg-duration-300 twg-ease-linear hover:twg-opacity-70 twg-text-red-500"> <i class="fa-regular fa-trash-can"></i> <span>Delete</span> </li>
                                                         </ul>
                                                     </div>
                                                 </div>
                                             </div>
                                     ...
                                     <div class="md:twg-mt-14 max-md:twg-mt-9 twg-mb-5">
                                         <div class="twg-flex twg-items-center twg-justify-center twg-relative">
                                             ...
                                             <div class="twg-absolute twg-left-0 twg-top-50/100 -twg-translate-y-1/2 twg-bg-secondary-800 twg-h-1px twg-w-full"> </div>
                                         </div>
                                     </div>
                                     <div class="twg-flex twg-gap-3">
                                         ...
                                         <div class="twg-flex-1 twg-space-y-2">
                                             ...
                                             <div class="twg-grid twg-grid-cols-3 twg-gap-3 twg-pb-6px">
                                                 <div
                                                     class="twg-rounded-12px twg-overflow-hidden twg-shadow-md twg-cursor-pointer">
                                                     <img src="../../../assets/images/inbox-image-1.png" class="twg-w-full twg-object-cover" alt="" />
                                                 </div>
                                                 <div
                                                     class="twg-rounded-12px twg-overflow-hidden twg-shadow-md twg-cursor-pointer">
                                                     <img src="../../../assets/images/inbox-image-2.png" class="twg-w-full twg-object-cover" alt="" />
                                                 </div>
                                             </div>
                                         </div>
                                     </div>
                                 ...
                                 <div class="twg-flex twg-gap-3 twg-max-w-80/100 twg-ml-auto twg-my-5">
                                     <div class="twg-flex-1 twg-space-y-2">
                                         ...
                                         <div class="twg-flex twg-justify-end twg-items-center">
                                             <div class="twg-relative"> <button class="dropdown-action twg-pr-3"> <svg width="4" height="14" viewBox="0 0 4 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                         <path d="M1.55556 3.11111C1.86322 3.11111 2.16397 3.01988 2.41978 2.84895C2.67559 2.67803 2.87497 2.43508 2.9927 2.15084C3.11044 1.8666 3.14124 1.55383 3.08122 1.25208C3.0212 0.950334 2.87305 0.67316 2.6555 0.455612C2.43795 0.238064 2.16078 0.0899117 1.85903 0.0298903C1.55728 -0.0301312 1.24451 0.000673993 0.960271 0.11841C0.676031 0.236147 0.433086 0.435526 0.262159 0.691336C0.0912327 0.947146 8.38281e-07 1.2479 8.38281e-07 1.55556C8.38281e-07 1.96811 0.16389 2.36378 0.455613 2.6555C0.747336 2.94722 1.143 3.11111 1.55556 3.11111ZM1.55556 10.8889C1.2479 10.8889 0.947146 10.9801 0.691336 11.151C0.435526 11.322 0.236147 11.5649 0.11841 11.8492C0.000673993 12.1334 -0.0301312 12.4462 0.0298903 12.7479C0.0899117 13.0497 0.238064 13.3268 0.455613 13.5444C0.673161 13.7619 0.950334 13.9101 1.25208 13.9701C1.55383 14.0301 1.8666 13.9993 2.15084 13.8816C2.43508 13.7639 2.67803 13.5645 2.84895 13.3087C3.01988 13.0529 3.11111 12.7521 3.11111 12.4444C3.11111 12.0319 2.94722 11.6362 2.6555 11.3445C2.36378 11.0528 1.96812 10.8889 1.55556 10.8889ZM1.55556 5.44444C1.2479 5.44444 0.947146 5.53568 0.691336 5.7066C0.435526 5.87753 0.236147 6.12047 0.11841 6.40471C0.000673993 6.68896 -0.0301312 7.00173 0.0298903 7.30347C0.0899117 7.60522 0.238064 7.88239 0.455613 8.09994C0.673161 8.31749 0.950334 8.46564 1.25208 8.52567C1.55383 8.58569 1.8666 8.55488 2.15084 8.43715C2.43508 8.31941 2.67803 8.12003 2.84895 7.86422C3.01988 7.60841 3.11111 7.30766 3.11111 7C3.11111 6.58744 2.94722 6.19178 2.6555 5.90006C2.36378 5.60833 1.96812 5.44444 1.55556 5.44444Z" fill="#6B6B6C" />
                                                     </svg> </button>
                                                 <div class="twg-absolute twg-top-full twg-right-0 twg-min-w-90px twg-w-full twg-bg-white twg-shadow-md twg-rounded-md twg-hidden dropdown-menu twg-z-50">
                                                     <ul class="twg-list-none twg-px-2 twg-py-1 twg-space-y-1">
                                     ...
                                     <div class="twg-size-34px twg-rounded-full twg-overflow-hidden"> <img src="../../../assets/images/messages-icon-dp-3.png" class="twg-size-full" alt="" /> </div>
                                 </div>
                                 <div class="twg-flex twg-gap-3">
                                     <div class="twg-size-34px twg-rounded-full twg-overflow-hidden"> <img src="../../../assets/images/messages-icon-dp-4.png" class="twg-size-full" alt="" /> </div>
                                     <div class="twg-flex-1 twg-space-y-2">
                                         <div class="twg-flex twg-items-center twg-gap-6">
                                             <h4 class="lg:twg-text-16px max-lg:twg-text-14px twg-font-bold twg-text-dark-100"> Killan James </h4>
                                             <p class="lg:twg-text-13px max-lg:twg-text-12px twg-text-light-500"> 10:12 AM </p>
                             ...
                             <div class="twg-mt-10 md:twg-p-5 max-md:twg-p-2 twg-bg-[#F4F9FD] lg:twg-sticky lg:twg-bottom-0 lg:twg-z-4">
                                 <div class="twg-bg-accent-100 twg-rounded-full twg-pl-20px twg-pr-5px twg-flex twg-items-center md:twg-gap-4 max-md:twg-gap-2 twg-overflow-hidden"> <button> <svg width="12" height="18" viewBox="0 0 12 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                         ...
                                         </svg> </button> <input type="text" class="twg-py-13px !twg-px-0 twg-flex-1 twg-text-14px !twg-ring-0 !twg-shadow-none !twg-outline-none !twg-border-none twg-text-light-500 max-md:twg-max-w-140px" placeholder="Add a comment..." /> <button class="twg-ml-auto"> <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                         ...
                                         </svg> </button> <button class=""> <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                         ...
                                         </svg> </button> <button class="twg-size-10 twg-rounded-full twg-grid twg-place-items-center twg-bg-primary-100 twg-text-accent-100 twg-transition-opacity twg-duration-300 twg-ease-linear hover:twg-opacity-70"> <svg width="20" height="19" viewBox="0 0 20 19" fill="none" xmlns="http://www.w3.org/2000/svg" class="twg-mb-2px twg-ml-2px">
                     ...
                     <div class="md:twg-p-5 lg:twg-max-w-276px twg-w-full lg:twg-bg-light-400 max-lg:twg-mt-4 twg-flex twg-flex-col lg:twg-h-full lg:twg-overflow-y-auto twg-hide-scrollbar">
                         ...
                         <div class="twg-mt-10 twg-w-full">
                             <div class="twg-relative twg-w-full"> <button class="dropdown-action lg:twg-text-16px max-lg:twg-text-14px twg-font-bold twg-text-light-500 twg-w-full twg-flex twg-items-center twg-justify-between"> <span>Attachments</span> <svg width="13" height="8" viewBox="0 0 13 8" fill="none" xmlns="http://www.w3.org/2000/svg" class="dropdown-action-icon">
                             ...
                             </div> <button class="lg:twg-text-13px max-lg:twg-text-12px twg-text-primary-100 twg-font-medium twg-mt-4">View all</button>
                         </div>
                     </div>
                 </div>
             </div>
